...
class AppLinkInitState extends State<AppLinkInit> with TickerProviderStateMixin {
  ...
  late final Animation<double> _wordsMove;
  ...
  void _generateFontSizes() {
    if (fontSizes.length != words.length) {
      ...
      for (int i = 0; i < words.length; i++) {
        fontSizes.add((rnd.nextInt(16) + 15).toDouble());
      }
    }
  }
  ...
  void initState() {
    ...
    words = [
      widget.appmon.name.toUpperCase().replaceAll("MON", ""), widget.appmon.type.name.toUpperCase(),
      widget.appmon.grade.name.toUpperCase(), widget.appmon.app.toUpperCase(),
      "アプリンク", "APPLINK", "FUSION", "アプモン",  "DIGIMON", "APPMON",
      widget.appmonLinked.name.toUpperCase().replaceAll("MON", ""), widget.appmonLinked.type.name.toUpperCase(),
      widget.appmonLinked.grade.name.toUpperCase(), widget.appmonLinked.app.toUpperCase(),
      widget.appmon.name.toUpperCase().replaceAll("MON", ""), widget.appmon.type.name.toUpperCase(),
      widget.appmon.grade.name.toUpperCase(), widget.appmon.app.toUpperCase(),
      "アプリンク", "APPLINK", "FUSION", "アプモン",  "DIGIMON", "APPMON",
      widget.appmonLinked.name.toUpperCase().replaceAll("MON", ""), widget.appmonLinked.type.name.toUpperCase(),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: AnimatedBuilder(
        animation: Listenable.merge([_contentController, _cornerController, _wordsController]),
                  ...
                  Positioned(
                    ...
                    top: size.height / 2 +
                        initialPositions[i].dy *
                            ...
                            (1 - _wordsMove.value),
                    child: Opacity(
                      opacity: 1 - _cornerController.value,
